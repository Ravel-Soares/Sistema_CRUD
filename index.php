    ...
    <div><a style="text-decoration: none;" href="index.php"><h1 style="color: #0d6efd; margin: 10px 0 10px 10px ; text-decoration: none;">CRUD</h1></a></div>
     ...
     <button type="submit"  style="border: none ; background-color: white ;">
       <svg 
        ...
        <input style=" padding: 10px ; height: 40px ; border: none; background-color: #e3eaef ; border-radius: 5px; outline: none;" type="text" name="pesquisa" class="pesquisar" placeholder="procure um nome">
     </form>
