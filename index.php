    ...
    ?>
     ...
     <button type="submit"  style="border: none ; background-color: none;">
       <svg 
        ...
        <input type="text" name="pesquisa" class="pesquisar" placeholder="procure um nome">
     </form>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Configurar banco</h5>
     ...
     <input class="input-opcoes" type="text" name="edita">
     <br>

      <label class="titulo-opcoes">E-mail</label>
     <input class="input-opcoes" type="email" name="edita">
     <br>
      <label class="titulo-opcoes">Senha</label>
     <input class="input-opcoes" type="password" name="edita">
     <br>
     <div>
